...
#include "drone_msgs/msg/detail/primitive__rosidl_typesupport_fastrtps_c.h"
...
using _Primitive__ros_msg_type = drone_msgs__msg__Primitive;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: step_distance
  {
    cdr << ros_message->step_distance;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name step_distance
  {
    size_t item_size = sizeof(ros_message->step_distance);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Primitive__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drone_msgs__msg__Primitive(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_msgs__msg__Primitive;
    is_plain =
      (
      offsetof(DataType, step_distance) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Primitive__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drone_msgs__msg__Primitive(
