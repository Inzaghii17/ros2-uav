...
#include "drone_msgs/msg/detail/primitive_status__rosidl_typesupport_fastrtps_c.h"
...
using _PrimitiveStatus__ros_msg_type = drone_msgs__msg__PrimitiveStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PrimitiveStatus__ros_msg_type * ros_message = static_cast<const _PrimitiveStatus__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: total_primitives
  {
    cdr << ros_message->total_primitives;
  }

  // Field name: mission_complete
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PrimitiveStatus__ros_msg_type * ros_message = static_cast<_PrimitiveStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: drone_name
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_drone_msgs__msg__PrimitiveStatus(
  const void * untyped_ros_message,
...
static uint32_t _PrimitiveStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drone_msgs__msg__PrimitiveStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_drone_msgs
size_t max_serialized_size_drone_msgs__msg__PrimitiveStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_msgs__msg__PrimitiveStatus;
    is_plain =
      (
...
static size_t _PrimitiveStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drone_msgs__msg__PrimitiveStatus(
...
static message_type_support_callbacks_t __callbacks_PrimitiveStatus = {
  "drone_msgs::msg",
  "PrimitiveStatus",
...
static rosidl_message_type_support_t _PrimitiveStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PrimitiveStatus,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_msgs, msg, PrimitiveStatus)() {
  return &_PrimitiveStatus__type_support;
}
