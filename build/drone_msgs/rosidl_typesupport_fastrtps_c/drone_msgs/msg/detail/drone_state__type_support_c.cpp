...
#include "drone_msgs/msg/detail/drone_state__rosidl_typesupport_fastrtps_c.h"
...
using _DroneState__ros_msg_type = drone_msgs__msg__DroneState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: current_primitive_index
  {
    cdr << ros_message->current_primitive_index;
  }
...
size_t get_serialized_size_drone_msgs__msg__DroneState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DroneState__ros_msg_type * ros_message = static_cast<const _DroneState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name current_primitive_index
  {
    size_t item_size = sizeof(ros_message->current_primitive_index);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _DroneState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drone_msgs__msg__DroneState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_drone_msgs
size_t max_serialized_size_drone_msgs__msg__DroneState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_msgs__msg__DroneState;
    is_plain =
      (
      offsetof(DataType, current_primitive_index) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _DroneState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drone_msgs__msg__DroneState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_msgs, msg, DroneState)() {
