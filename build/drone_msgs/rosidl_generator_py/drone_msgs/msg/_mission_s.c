...
bool drone_msgs__msg__mission__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("drone_msgs.msg._mission.Mission", full_classname_dest, 31) == 0);
  }
  drone_msgs__msg__Mission * ros_message = _ros_message;
  {  // drone_name
  ...
  {  // source
    ...
    if (!geometry_msgs__msg__point__convert_from_py(field, &ros_message->source)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // destination
    ...
    if (!geometry_msgs__msg__point__convert_from_py(field, &ros_message->destination)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * drone_msgs__msg__mission__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("drone_msgs.msg._mission");
  ...
  {  // source
    PyObject * field = NULL;
    field = geometry_msgs__msg__point__convert_to_py(&ros_message->source);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // destination
    PyObject * field = NULL;
    field = geometry_msgs__msg__point__convert_to_py(&ros_message->destination);
    if (!field) {
      return NULL;
    }
    {
