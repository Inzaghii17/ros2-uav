...
class Metaclass_MissionPlan(type):
    """Metaclass of message 'MissionPlan'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'drone_msgs.msg.MissionPlan')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mission_plan
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mission_plan
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mission_plan
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mission_plan
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mission_plan

            from drone_msgs.msg import Primitive
...
class MissionPlan(metaclass=Metaclass_MissionPlan):
    """Message class 'MissionPlan'."""
    ...
    _fields_and_field_types = {
        'drone_name': 'string',
        'primitives': 'sequence<drone_msgs/Primitive>',
        'mission_id': 'uint32',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['drone_msgs', 'msg'], 'Primitive')),  # noqa: E501
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'primitives' field must be a set or sequence and each value of type 'Primitive'"
