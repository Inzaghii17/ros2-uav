...
bool drone_msgs__msg__drone_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("drone_msgs.msg._drone_state.DroneState", full_classname_dest, 38) == 0);
  }
  drone_msgs__msg__DroneState * ros_message = _ros_message;
  {  // drone_name
  ...
  {  // current_primitive_index
    ...
    ros_message->current_primitive_index = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * drone_msgs__msg__drone_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("drone_msgs.msg._drone_state");
