...
{
  new (message_memory) drone_msgs::msg::Primitive(_init);
}

void Primitive_fini_function(void * message_memory)
{
  auto typed_message = static_cast<drone_msgs::msg::Primitive *>(message_memory);
  typed_message->~Primitive();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Primitive_message_member_array[2] = {
  {
    "type",  // name
    ...
    offsetof(drone_msgs::msg::Primitive, type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drone_msgs::msg::Primitive, step_distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Primitive_message_members = {
  ...
  2,  // number of fields
  sizeof(drone_msgs::msg::Primitive),
...
get_message_type_support_handle<drone_msgs::msg::Primitive>()
{
  return &::drone_msgs::msg::rosidl_typesupport_introspection_cpp::Primitive_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drone_msgs, msg, Primitive)() {
  return &::drone_msgs::msg::rosidl_typesupport_introspection_cpp::Primitive_message_type_support_handle;
}
