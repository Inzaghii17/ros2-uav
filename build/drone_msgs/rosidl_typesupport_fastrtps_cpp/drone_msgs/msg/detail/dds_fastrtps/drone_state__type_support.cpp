...
#include "drone_msgs/msg/detail/drone_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const drone_msgs::msg::DroneState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  drone_msgs::msg::DroneState & ros_message)
{
  // Member: drone_name
  cdr >> ros_message.drone_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_msgs::msg::DroneState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const drone_msgs::msg::DroneState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<drone_msgs::msg::DroneState *>(
    untyped_ros_message);
...
{
  return &drone_msgs::msg::typesupport_fastrtps_cpp::_DroneState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drone_msgs, msg, DroneState)() {
  return &drone_msgs::msg::typesupport_fastrtps_cpp::_DroneState__handle;
}
